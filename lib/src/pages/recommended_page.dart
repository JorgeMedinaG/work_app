...
class RecommendJobsPage extends StatefulWidget {
  @override
  _RecommendJobsPageState createState() => _RecommendJobsPageState();
}

class _RecommendJobsPageState extends State<RecommendJobsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Recommended Jobs', style: GoogleFonts.poppins(
  ...
  Widget _jobList(){
    ...
    return FutureBuilder(
      future: jobProvider.recommendedJobs(),
